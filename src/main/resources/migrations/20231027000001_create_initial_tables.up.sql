...
CREATE TABLE IF NOT EXISTS job_executions (
    id VARCHAR(36) PRIMARY KEY,
    job_instance_id VARCHAR(36) REFERENCES job_instances(id),
    job_name VARCHAR(255) NOT NULL,
    ...
    CONSTRAINT fk_job_instance FOREIGN KEY (job_instance_id) REFERENCES job_instances(id)
);
...
CREATE TABLE IF NOT EXISTS step_executions (
    ...
    failure_exceptions JSONB,
    execution_context JSONB,
    CONSTRAINT fk_job_execution FOREIGN KEY (job_execution_id) REFERENCES job_executions(id)
);
